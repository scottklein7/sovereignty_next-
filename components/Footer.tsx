...
function Footer() {
    ...
    return (
        <footer className="cinzel font-extrabold py-12 items-center text-center text-white bg-sky-100" style={{ backgroundImage: 'url("/dinnerbarn.webp")', backgroundSize: 'cover' }}>
            <div className="flex flex-col gap-5 bg-black bg-opacity-20">
                <div className=" flex gap-5 md:gap-10 items-center justify-center">
                    ...
                    <div className="flex flex-col text-lg gap-2 group-hover:md:flex-row  md:gap-0">
                        <Link href="/contact">
                            <a className="cinzel drop-shadow-2xl hover:text-emerald-800">Contact Us!</a>
                        </Link>
                        <Link href="/blog">
                            <a className="cinzel drop-shadow-2xl hover:text-emerald-800">Blog</a>
                        </Link>
                        <Link href="/weddingphotos">
                            <a className="cinzel drop-shadow-2xl hover:text-emerald-800">Wedding Photos</a>
                        </Link>
                        <Link href="/https://calendly.com/sovereigntyfarms/wedding-venue-meeting?month=2023-01">
                            <a className="cinzel drop-shadow-2xl hover:text-emerald-800">Wedding Consult</a>
                        </Link>
                    </div>
                </div>
