                    ...
                    <div className="container mx-auto">
                        <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
                            <div className="flex flex-col justify-center items-center">
                                ...
                                <p className="mt-4 text-3xl text-green-400 ">Sovereignty Farms was born out of a deep passion for sustainable farming and reconnecting with our food sources. We set out on a journey to create a place where we can grow, raise, and harvest our own food, while preserving the natural beauty of the Shenandoah Valley.</p>
                            </div>
                            <div className="flex flex-col justify-center items-center">
                                <h2 className="text-5xl font-extrabold text-green-800">Our Mission</h2>
                                <p className="mt-4 text-3xl text-green-400">At Sovereignty Farms, our mission is to provide our community with locally sourced, grass-fed beef and organic produce. We prioritize regenerative farming practices and sustainable agriculture to ensure the health and well-being of our land, animals, and customers.</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-24 bg-green-800 text-white">
                    <div className="container mx-auto">
                        <div className="text-center">
                            ...
                            <p className="mt-4 text-xl">Experience the joy of growing your own food and savoring the flavors of nature.</p>
